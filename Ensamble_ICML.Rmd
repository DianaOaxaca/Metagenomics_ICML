...
```{bash eval=F}
java -jar /opt/Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 10 -phred33 -trimlog triminfo.txt SRR_R1_001.fastq SRR_R2_001.fastq  SRR_R1_trimm.fastq  SRR_R1_unpair.fastq SRR_R2_trimm.fastq SRR_R2_unpair.fastq ILLUMINACLIP:/opt/Trimmomatic-0.39/adapters/TruSeq2-PE.fa:2:30:10:8:True LEADING:5 TRAILING:5 SLIDINGWINDOW:5:15 MINLEN:50
```
